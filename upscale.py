...
# generator.load_state_dict(torch.load("/Users/ransu/Desktop/一時補完/generator_epoch_15.pth"))
# generator.load_state_dict(torch.load("/Users/ransu/Desktop/generator_batch_228.pth"))
...
fake_hr.save("w_output" + str(num) +".jpg")  # 保存
